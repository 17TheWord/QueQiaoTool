 ...
 * TitlePayload 反序列化器
 *
 * <p>用于将 JSON 数据反序列化为 TitlePayload 对象
 */
public class TitlePayloadDeserializer implements JsonDeserializer<TitlePayload> {
   ...
   * 反序列化 Title 消息
   *
   * <p>接管所有 TitlePayload 及其子类的反序列化任务
   *
   * @param json Json数据
   * @param type 目标类型
   ...
   */
  @Override
  public TitlePayload deserialize(JsonElement json, Type type, JsonDeserializationContext context)
