...
public class Tool {
   ...
   */
  @Deprecated public static Logger logger = null;
   ...
   */
  @Deprecated public static Config config = null;
   ...
   */
  @Deprecated public static String SERVER_VERSION = "Unknown";
   ...
   */
  @Deprecated public static String SERVER_TYPE = "Unknown";
   ...
   */
  @Deprecated public static WebsocketManager websocketManager = null;
   ...
   */
  @Deprecated public static HandleApiService handleApiService = null;
  ...
  public static String isRegisterOrLoginCommand(String command) {
    ...
    if (command.startsWith("l ")
        ...
        || command.startsWith(BaseConstant.COMMAND_HEADER + " ")) return "";
    return command;
  }
  ...
  public static CommonTextComponent getPrefixComponent() {
    CommonTextComponent CommonTextComponent =
        new CommonTextComponent(GlobalContext.getConfig().getMessagePrefix());
