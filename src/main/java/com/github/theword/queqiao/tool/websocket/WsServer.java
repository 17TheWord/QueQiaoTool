...
public class WsServer extends WebSocketServer {
  ...
  public void onOpen(WebSocket webSocket, ClientHandshake clientHandshake) {
    ...
    try {
      ...
      this.logger.error(
          WebsocketConstantMessage.Server.SERVER_NAME_DECODE_FAILED_HEADER,
          getClientAddress(webSocket),
          originServerName,
          e.getMessage());
  ...
  public void onClose(WebSocket webSocket, int code, String reason, boolean remote) {
    String closeReason =
        remote
            ? WebsocketConstantMessage.Server.CLIENT_DISCONNECTED
            : WebsocketConstantMessage.Server.CLIENT_HAD_BEEN_DISCONNECTED;
