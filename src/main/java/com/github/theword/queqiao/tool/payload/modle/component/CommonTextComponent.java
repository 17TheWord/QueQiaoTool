...
public class CommonTextComponent extends CommonBaseComponent {
    ...
    public CommonTextComponent(
                               String text, String color, String font, boolean bold, boolean italic, boolean underlined, boolean strikethrough, boolean obfuscated, String insertion) {
        super(text, color, font, bold, italic, underlined, strikethrough, obfuscated, insertion);
    }

    public CommonTextComponent(
                               String text, CommonClickEvent clickEvent, CommonHoverEvent hoverEvent) {
        super(text);
        this.clickEvent = clickEvent;
        this.hoverEvent = hoverEvent;
    }
    ...
    public CommonTextComponent(
                               String text, String color, String font, boolean bold, boolean italic, boolean underlined, boolean strikethrough, boolean obfuscated, String insertion, CommonClickEvent clickEvent, CommonHoverEvent hoverEvent) {
        super(text, color, font, bold, italic, underlined, strikethrough, obfuscated, insertion);
        this.clickEvent = clickEvent;
        this.hoverEvent = hoverEvent;
    }
